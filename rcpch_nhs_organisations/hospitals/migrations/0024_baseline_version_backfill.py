    ...
    for org in Organisation.objects.all():
        rows.append(
            OrganisationVersion(
                ...
                valid_to=None,
                name=(org.name[:100] if org.name else None),
                website=(org.website[:100] if org.website and len(org.website) > 100 else org.website),
                address1=(org.address1[:100] if org.address1 and len(org.address1) > 100 else org.address1),
                address2=(org.address2[:100] if org.address2 and len(org.address2) > 100 else org.address2),
                address3=(org.address3[:100] if org.address3 and len(org.address3) > 100 else org.address3),
                telephone=(org.telephone[:100] if org.telephone and len(org.telephone) > 100 else org.telephone),
                city=(org.city[:100] if org.city and len(org.city) > 100 else org.city),
                county=(org.county[:100] if org.county and len(org.county) > 100 else org.county),
    ...
    for trust in Trust.objects.all():
        rows.append(
            TrustVersion(
                ...
                valid_from=valid_from,
                valid_to=None,
                name=(trust.name[:100] if trust.name and len(trust.name) > 100 else trust.name),
                address_line_1=(trust.address_line_1[:100] if trust.address_line_1 and len(trust.address_line_1) > 100 else trust.address_line_1),
                address_line_2=(trust.address_line_2[:100] if trust.address_line_2 and len(trust.address_line_2) > 100 else trust.address_line_2),
                town=(trust.town[:100] if trust.town and len(trust.town) > 100 else trust.town),
    ...
    for icb in IntegratedCareBoard.objects.all():
        rows.append(
            IntegratedCareBoardVersion(
                ...
                valid_from=valid_from,
                valid_to=None,
                name=(icb.name[:77] if icb.name and len(icb.name) > 77 else icb.name),
                bng_e=icb.bng_e,
                bng_n=icb.bng_n,
                long=icb.long,
                lat=icb.lat,
